...
public class CompanyListAdapter extends RecyclerView.Adapter<CompanyListAdapter.CompaniesListViewHolder> {
    private final List<Company> companiesList;

    public CompanyListAdapter(List<Company> companiesList) {
        this.companiesList = companiesList;
    }

    @NonNull
    @Override
    public CompanyListAdapter.CompaniesListViewHolder onCreateViewHolder(
    ...
    public class CompaniesListViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView itemCompanyNameTextView, itemCompanyTitleTextView,
                itemCompanyCountryTextView;
